    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8">
        ...
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-4xl font-bold gradient-text">Data Analytics</h1>
        </div>
        <p className="text-muted-foreground text-lg">Data analysis, visualization, and business intelligence</p>
      </div>

      <div className="mb-8">
        <h2 className="section-header">Subjects</h2>
        <SubjectList subjects={daSubjects} semesterId={4} specializationPath="da" />
      </div>
    </div>
  )
}
